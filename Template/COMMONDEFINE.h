...
*      18  表示joinmot文件标记位
*      19  表示压缩项目源码标记位
*      20  表示依赖ID通过解析依赖文件和宏定义文件获得
*      21  表示对CL_Ver_Parts_ex.h文件进行Check
*      150 表示错误信息标记位
*      151 表示普通信息标记位
*
*/
...
#define SISVNUpdateflag       5
#define SIRelyFileflag        6
#define SICarInfoFileflag     7
#define SICodeFileflag        8
#define SISHDefineFileflag    9
#define SIPFileflag           10
#define SISWFileflag          11
#define SIBuildFileflag       12
...
#define SIZIPFileflag         19
#define SIRelyIDDealflag      20
#define SICLVERCheckflag      21
